          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition ${
                active
                  ? "bg-gradient-to-r from-[#1468F3] to-[#1468F3] text-white shadow-lg shadow-blue-950/40"
      ...
      {mobileOpen && (
        <>
          <button
            ...
            className="fixed inset-0 z-40 bg-[#1468F3]/70 backdrop-blur-sm md:hidden"
          />
      ...
      <div className="md:pl-72">
        <header className="sticky top-0 z-30 flex h-20 items-center justify-between border-b border-slate-200 bg-white/90 px-4 backdrop-blur-xl sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#1468F3]">
