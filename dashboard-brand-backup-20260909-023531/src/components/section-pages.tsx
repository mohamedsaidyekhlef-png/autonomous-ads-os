  ...
  return (
    <header className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
      <div className="flex items-start gap-4">
        <div className="rounded-2xl bg-gradient-to-br from-[#1468F3] to-[#13C7E7] p-3 text-white shadow-lg shadow-blue-200">
          <Icon size={25} />
        </div>
      ...
      {action && (
        <button className="flex items-center justify-center gap-2 rounded-xl bg-slate-950 px-5 py-3 text-sm font-bold text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-blue-700">
          <Plus size={17} />
          {action}
        </button>
      )}
...
function EmptyState({
  ...
  return (
    <div className="flex min-h-56 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-slate-50/60 p-8 text-center">
      ...
      {action && (
        <button className="mt-5 rounded-xl bg-slate-950 px-5 py-2.5 text-sm font-bold text-white">
          {action}
        </button>
      )}
    </div>
  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-7">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {platforms.map((platform) => (
          ...
          >
            ...
            <button className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 py-3 text-sm font-bold text-white transition group-hover:bg-blue-700">
              <Link2 size={16} />
      ...
      <section className="grid gap-6 xl:grid-cols-[1.4fr_0.8fr]">
        ...
        <article className="rounded-[1.75rem] bg-slate-950 p-6 text-white shadow-xl">
    ...
    <div className="mx-auto max-w-[1600px] space-y-7">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.4fr_0.8fr]">
        ...
        <article className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <button className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-slate-950 px-5 py-3 text-sm font-bold text-white">
            <Play size={17} />
  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-7">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
        ...
        <article className="rounded-[1.75rem] bg-gradient-to-br from-[#1468F3] to-[#093B9C] p-6 text-white shadow-xl">
    ...
    <div className="mx-auto max-w-[1600px] space-y-7">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
        <article className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <button className="mt-6 rounded-xl bg-slate-950 px-5 py-3 text-sm font-bold text-white">
